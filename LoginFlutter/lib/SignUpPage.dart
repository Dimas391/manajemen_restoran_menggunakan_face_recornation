...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _login() async {
    ...
    String url = 'http://192.168.81.78/manajemen_resto/config/login.php';
  ...
  void _launchPHPPage() async {
    ...
    final url = Uri.parse('http://192.168.81.78/manajemen_resto/Page/home.php?username=$username&id_pelanggan=$idPelanggan');
