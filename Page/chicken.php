...
$sql = "SELECT id_menu, nama_menu, keterangan, harga, gambar_menu FROM menu WHERE gambar_menu LIKE '%chicken%'";
...
<div class="container">
    ...
    <div class="tabs">
        ...
        <button class="tab active"><a href="chicken.php" style="text-decoration: none; color: inherit;">Chicken</a></button>
