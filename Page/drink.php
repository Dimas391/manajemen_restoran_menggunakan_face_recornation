...
$sql = "SELECT id_menu, nama_menu, keterangan, harga, gambar_menu FROM menu WHERE gambar_menu LIKE '%drink%'";
...
<div class="container">
    ...
    <div class="tabs">
        ...
        <button class="tab active"><a href="drink.php" style="text-decoration: none; color: inherit;">drink</a></button>
