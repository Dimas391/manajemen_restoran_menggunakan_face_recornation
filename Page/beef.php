...
$sql = "SELECT id_menu, nama_menu, keterangan, harga, gambar_menu FROM menu WHERE gambar_menu LIKE '%beef%'";
...
<div class="container">
    ...
    <div class="tabs">
        ...
        <button class="tab active"><a href="beef.php" style="text-decoration: none; color: inherit;">Beef</a></button>
        ...
        <button class="tab"><a href="dessert.php" style="text-decoration: none; color: inherit;">dessert</a></button>
    </div>
